    ...
    <head>
        ...
        <style>
            ...
            *,:after,:before{box-sizing:border-box;border:0 solid #e2e8f0}
            ...
            .sm\:block{display:block}.sm\:items-center{align-items:center}.sm\:justify-start{justify-content:flex-start}
            ...
            .sm\:text-right{text-align:right}}@media (min-width:768px){.md\:border-t-0{border-top-width:0}
